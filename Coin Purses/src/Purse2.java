...
public class Purse2 
{
	static ArrayList<String> purse2 = new ArrayList<String>();
	...
	{
		System.out.println("Purse2" + purse2);
	}
	...
	public static void reverse()
	{
		...
		for(int i = purse2.size(); i > 0; i--)
		{
			purseReverse.add(purse2.get(i-1));
		}
		purse2 = purseReverse;
	}
	/**This transfers the contents from one purse to another.
	 * 
	 * @param purse This is the first purse you added coins to and will take coins out of.
	 */
	public static void transfer(ArrayList<String> purse)
	{
		for(int i = 0; i < Purse.purse.size(); i++)
		{
			purse2.add(Purse.purse.get(i));
		}
		Purse.purse.clear();
	}
}